...
export function Timer({ 
    ...
    handleTabClick, tabsClicked,
    timerStarted, setTimerStarted,
    timerPaused, setTimerPaused,
    timerReset, setTimerReset, 
    timerRef, restartTimer }) {
        const [editingTimer, setEditingTimer] = useState(false);
        const [shortBreaksTaken, setShortBreaksTaken] = useState(0);
        ...
        function advanceTimer() {
                ...
                if (remaingTotalSeconds < 0) {
                    ...
                    if (tabsClicked["tab-two"] && shortBreaksTaken < 4) {
